    ...
    public void onEnable() {
        ...
        this.getApi().getEventManager().registerOnJoin(new Consumer<ServerData>() {
            ...
            public void accept(ServerData serverData) {
                if(enabled == true) {
                    LabyMod.getInstance().getGuiCustomAchievement().displayAchievement("https://media.discordapp.net/attachments/645344272815620118/675788438217162752/SkyZeroGA.png","§4§lS§c§lKY§4§lZ§c§lERO", "§7Willkommen zurück §c" + LabyMod.getInstance().getGameProfile().getName() + "§7!\n§7Schreibe §c--help §7für mehr Infos");
                }
            }
        });
